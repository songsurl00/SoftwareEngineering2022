      ...
      <BodyWrapper>
        <ContentWrapper>
          <ClothImageWrapper>
            ...
            <ClothImage style={{backgroundImage: cloth.imgUrl && `url(${cloth.imgUrl})`}}/>
          </ClothImageWrapper>
          <ClothContentWrapper>
            <ClothInfoWrapper>
              ...
              <ClothInfoRow>
                ...
                <ClothInfoRowContent>{cloth.category || '-'}</ClothInfoRowContent>
              </ClothInfoRow>
              <ClothInfoRow>
              ...
              <ClothInfoRow>
                ...
                <ClothInfoRowContent>{cloth.purchaseDate || '-'}</ClothInfoRowContent>
              </ClothInfoRow>
              <ClothInfoRow>
                <ClothInfoRowTitle>구매장소</ClothInfoRowTitle>
                <ClothInfoRowContent>{cloth.purchasePlace || '-'}</ClothInfoRowContent>
              </ClothInfoRow>
            </ClothInfoWrapper>
            <ClothButtonWrapper>
              <ClothChangeButton>수정하기</ClothChangeButton>
              <ClothDeleteButton>삭제하기</ClothDeleteButton>
            </ClothButtonWrapper>
          </ClothContentWrapper>
        </ContentWrapper>
      </BodyWrapper>
